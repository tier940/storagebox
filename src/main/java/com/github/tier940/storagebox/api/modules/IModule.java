...
public interface IModule {
     ...
     * <p>
     * e.g. <code>new ResourceLocation("storagebox", "foo_module")</code> represents a dependency on the module
     * "foo_module" in the container "storagebox"
     */
    @NotNull
    ...
    /**
     * Register packets using StorageBox's packet handling API here.
     */
