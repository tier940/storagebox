...
import com.github.tier940.storagebox.api.modules.*;
...
public class ModuleManager implements IModuleManager {
    ...
    private final Logger logger = LogManager.getLogger("StorageBox Module Loader");
    ...
    private void configureModules(Map<String, List<IModule>> modules) {
        ...
        config.addCustomCategoryComment(MODULE_CFG_CATEGORY_NAME,
                "Module configuration file. Can individually enable/disable modules from StorageBox and its addons");
